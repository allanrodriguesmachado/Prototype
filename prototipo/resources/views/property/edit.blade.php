...
@section('content')
    <div class="container my-3">
        <h3 class="text-muted">Formulario de edição</h3>
        ...
        <form action="<?= url('/imoveis/update', ['id' => $property->id]); ?>" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="rental_price" id="rental_price"
                       value="<?= $property->rental_price ?>" class="form-control">
            </div>

            <div class="form-group">
                <label for="sale_price">Valor de locação</label>
                <input type="text" name="sale_price" id="sale_price"
                       value="<?= $property->sale_price?>" class="form-control">
            </div>

            <button class="btn btn-success" type="submit">Atualizar Imovel</button>
        </form>
    </div>
@endsection
