...
!function (e, t) {
    ...
    return function (e) {
        ...
        !function (t, n) {
            ...
            var S = function (e) {
                var t, n, r, i, o, a, s, u, l, c, f, p, d, h, g, v, y, m, x, b = "sizzle" + 1 * new Date,
                    w = e.document, T = 0, C = 0, E = ue(), S = ue(), k = ue(), j = ue(), A = function (e, t) {
                        return e === t && (f = !0), 0
                    ...
                    F = new RegExp(M + "+", "g"),
                    B = new RegExp("^" + M + "+|((?:^|[^\\\\])(?:\\\\.)*)" + M + "+$", "g"),
                    $ = new RegExp("^" + M + "*," + M + "*"), z = new RegExp("^" + M + "*([>+~]|" + M + ")" + M + "*"),
                    U = new RegExp(M + "|>"), X = new RegExp(W), V = new RegExp("^" + R + "$"), G = {
                        ID: new RegExp("^#(" + R + ")"),
                        CLASS: new RegExp("^\\.(" + R + ")"),
                        TAG: new RegExp("^(" + R + "|[*])"),
                        ATTR: new RegExp("^" + _),
            ...
            C.fn.extend({
                has: function (e) {
                    ...
                    if (!A.test(e)) for (; r < i; r++) for (n = this[r]; n && n !== t; n = n.parentNode) if (n.nodeType < 11 && (a ? a.index(n) > -1 : 1 === n.nodeType && C.find.matchesSelector(n, e))) {
                        o.push(n);
                        break
                    }
                                    ...
                                    return function () {
                                        var s = this, u = arguments, l = function () {
                                            ...
                                            if (!(e < o)) {
                                                ...
                                                l = n && ("object" == typeof n || "function" == typeof n) && n.then, y(l) ? i ? l.call(n, a(o, t, R, i), a(o, t, _, i)) : (o++, l.call(n, a(o, t, R, i), a(o, t, _, i), a(o, t, R, t.notifyWith))) : (r !== R && (s = void 0, u = [n]), (i || t.resolveWith)(s, u))
                                            }
                                        }, c = i ? l : function () {
                                            try {
                                                l()
            ...
            function _e(e, t, n, r) {
                ...
                if (p && (o = (i = Te(t, e[0].ownerDocument, !1, e, r)).firstChild, 1 === i.childNodes.length && (i = o), o || r)) {
                    ...
                    if (s) for (c = a[a.length - 1].ownerDocument, C.map(a, Ie), f = 0; f < s; f++) l = a[f], ye.test(l.type || "") && !J.access(l, "globalEval") && C.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? C._evalUrl && !l.noModule && C._evalUrl(l.src, {nonce: l.nonce || l.getAttribute("nonce")}, c) : w(l.textContent.replace(He, ""), l, c))
                }
                return e
            }
            ...
            function Ue(e, t, n) {
                ...
                return (n = n || Be(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || ae(e) || (a = C.style(e, t)), !v.pixelBoxStyles() && Fe.test(a) && ze.test(t) && (r = s.width, i = s.minWidth, o = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = r, s.minWidth = i, s.maxWidth = o)), void 0 !== a ? a + "" : a
            }
            ...
            var Lt = /%20/g, Ht = /#.*$/, Ot = /([?&])_=[^&]*/, Pt = /^(.*?):[ \t]*([^\r\n]*)$/gm,
                It = /^(?:GET|HEAD)$/, Mt = /^\/\//, Rt = {}, _t = {}, Wt = "*/".concat("*"), Ft = x.createElement("a");
            ...
            Ft.href = Et.href, C.extend({
                ...
                ajax: function (e, t) {
                    ...
                    for (f in (c = C.event && d.global) && 0 == C.active++ && C.event.trigger("ajaxStart"), d.type = d.type.toUpperCase(), d.hasContent = !It.test(d.type), i = d.url.replace(Ht, ""), d.hasContent ? d.data && d.processData && 0 === (d.contentType || "").indexOf("application/x-www-form-urlencoded") && (d.data = d.data.replace(Lt, "+")) : (p = d.url.slice(i.length), d.data && (d.processData || "string" == typeof d.data) && (i += (kt.test(i) ? "&" : "?") + d.data, delete d.data), !1 === d.cache && (i = i.replace(Ot, "$1"), p = (kt.test(i) ? "&" : "?") + "_=" + St.guid++ + p), d.url = i + p), d.ifModified && (C.lastModified[i] && E.setRequestHeader("If-Modified-Since", C.lastModified[i]), C.etag[i] && E.setRequestHeader("If-None-Match", C.etag[i])), (d.data && d.hasContent && !1 !== d.contentType || t.contentType) && E.setRequestHeader("Content-Type", d.contentType), E.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + Wt + "; q=0.01" : "") : d.accepts["*"]), d.headers) E.setRequestHeader(f, d.headers[f]);
        ...
        "use strict";
        n.r(t), n.d(t, "jQuerySpinner", (function () {
            return a
        }));
        var r = n(0), i = n.n(r);
        n(2);
        ...
        var a = function () {
            ...
            return t = e, (n = [{
                key: "createElement", value: function () {
                    try {
                        var e = i()("#".concat(this.parentId_)),
                            t = '<div id="'.concat(this.overlayId_, '" class="jquery-spinner-wrap"><div class="jquery-spinner-circle"><span class="jquery-spinner-bar"></span></div></div>'),
                            n = i.a.parseHTML(t);
                        e.append(n)
                    } catch (e) {
                        console.error(e)
                ...
                key: "removeElement", value: function () {
                    try {
